...
#         max_length=100
#     )  # Or ForeignKey if 'cuenta' refers to another model
#     monto = models.DecimalField(max_digits=10, decimal_places=2)  # For monetary values
#     numeros = models.CharField(
#         max_length=255, blank=True, null=True
#     )  # Could be a list of numbers, or a ManyToManyField if linked to a 'Numero' model
#     extras = models.TextField(
#         blank=True, null=True
#     )  # For additional, potentially longer text
#     notas = models.TextField(
#         blank=True, null=True
#     )  # For general notes about the purchase


# class Panel(models.Model):
#     # Overall statistics
#     total_participantes = models.IntegerField(
#         default=0, help_text="Número total de participantes registrados."
#     )
#     total_tickets_registrados = models.IntegerField(
#         default=0, help_text="Número total de tickets registrados en todas las compras."
#     )
#     total_por_confirmar = models.IntegerField(
#         default=0, help_text="Número total de compras/pagos pendientes de confirmación."
#     )
#     total_confirmados = models.IntegerField(
#         default=0, help_text="Número total de compras/pagos confirmados."
#     )
...
#         blank=True, null=True, help_text="Detalle de pagos que requieren confirmación."
#     )
#     pagos_confirmados = models.JSONField(
#         blank=True, null=True, help_text="Detalle de pagos ya confirmados."
#     )
...
#         blank=True, null=True, help_text="Top participantes con más tickets o compras."
#     )
...
#         max_length=100, blank=True, help_text="Nombre del banco asociado a la cuenta."
#     )
...
#         max_length=150, help_text="Nombre completo del participante."
#     )
...
#         max_length=100, blank=True, help_text="Ubicación general (ej. ciudad, estado)."
#     )
#     direccion = models.TextField(
#         blank=True, help_text="Dirección detallada del participante."
#     )
#     campo_extra = models.TextField(
#         blank=True, help_text="Campo extra para información adicional no estructurada."
#     )
...
#         default=0, help_text="Número total de todos los premios disponibles."
#     )
#     rifa_activa = models.IntegerField(
#         default=0, help_text="Número de premios asociados a rifas activas."
#     )
#     rifa_inactiva = models.IntegerField(
#         default=0, help_text="Número de premios asociados a rifas inactivas."
#     )
...
#     )
#     nombre = models.CharField(max_length=200, help_text="Nombre o título de la rifa.")
#     precio = models.DecimalField(
#         max_digits=10, decimal_places=2, help_text="Precio por ticket o participación."
#     )
#     fecha = models.DateField(
...
#         default=0, help_text="Cantidad de tickets disponibles para venta online."
#     )
...
#         default=0, help_text="Número de tickets vendidos hasta la fecha."
#     )
#     listado = models.TextField(
#         blank=True, help_text="Descripción o listado de premios asociados a la rifa."
#     )

#     activo = models.BooleanField(
#         default=True, help_text="Indica si la rifa está activa y disponible para venta."
#     )

#     total_participantes = models.IntegerField(
#         default=0, help_text="Número total de participantes en esta rifa."
#     )
