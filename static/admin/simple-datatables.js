            ...
            (function () {
                    ...
                    : (e
                      ...
                      s.valueDiffing &&
                        (t.value &&
                          ...
                          (i.value = t.value),
                        t.checked &&
                          b(i, "HTMLInputElement") &&
                          (i.checked = t.checked),
                        t.selected &&
                          b(i, "HTMLOptionElement") &&
                ...
                switch (o) {
                  ...
                  case s._const.modifyTextElement:
                    ...
                    s.textDiff(
                      ...
                      b(i.parentNode, "HTMLTextAreaElement") &&
                  ...
                  case s._const.replaceElement:
                    ...
                    i.parentNode.replaceChild(v(e[s._const.newValue], d, s), i);
                    break;
                  case s._const.relocateGroup:
                    m([], new Array(e[s._const.groupLength]), !0)
                      .map(function () {
                  ...
                  case s._const.removeTextElement:
                    ...
                    var h = i.parentNode;
                    h.removeChild(i),
                      b(h, "HTMLTextAreaElement") && (h.value = "");
                    break;
              ...
              var D = function (t) {
                ...
                x = function (t) {
                  return (
                    ...
                    delete t.innerDone,
                    delete t.valueDone,
                    !t.childNodes || t.childNodes.every(x)
                  );
                },
                O = function (t) {
                ...
                $ = function (t, e) {
                  return m([], new Array(t), !0).map(function () {
                    return e;
                  });
                },
                C = function (t, e) {
                      ...
                      d = function () {
                        var t = (function (t, e, s, i) {
                          var n = 0,
                            ...
                            o = t.length,
                            r = e.length,
                            l = m([], new Array(o + 1), !0).map(function () {
                              return [];
                            }),
                            d = N(t, e),
                            c = o === r;
                    ...
                    !(function (t, e, s) {
                      ...
                      switch (e[s._const.action]) {
                        ...
                        case s._const.modifySelected:
                          ...
                          break;
                        case s._const.replaceElement:
                          (l = O(e[s._const.newValue])), (a.childNodes[o] = l);
                          break;
                        case s._const.relocateGroup:
                          n.childNodes
                        ...
                        case s._const.addElement:
                          ...
                          (n =
                            null === (i = k(t, d)) || void 0 === i
                              ? void 0
                              : i.node),
                            (l = O(e[s._const.element])),
                    ...
                    : (t.attributes &&
                      ...
                      t.childNodes &&
                        ...
                        Array.prototype.slice
                          .call(t.childNodes)
                          .forEach(function (t) {
                            return s.childNodes.push(A(t, e));
                          })),
                      e.valueDiffing &&
                        (b(t, "HTMLTextAreaElement") && (s.value = t.value),
                        b(t, "HTMLInputElement") &&
              ...
              var H = {
                ...
                I = function (t, e) {
                  ...
                  for (var o = new RegExp(P), r = null, l = !1; !l; )
                ...
                Y = function (t, e) {
                  ...
                  return (
                    t.replace(L, function (r, l) {
                      var d = "/" !== r.charAt(1),
                        c = r.startsWith("\x3c!--"),
                        h = l + r.length,
                        u = t.charAt(h);
                      if (c) {
                        var p = I(r, e.caseSensitive).node;
                      ...
                      if (d) {
                        if (
                          ("svg" ===
                            (s = I(r, e.caseSensitive || o)).node.nodeName &&
                            (o = !0),
                          n++,
                          !s.voidElement && u && "<" !== u)
                        ) {
                          s.node.childNodes || (s.node.childNodes = []);
                          var m = R(t.slice(h, t.indexOf("<", h)));
                ...
                j = (function () {
                  function t(t, e, s) {
                    (this.options = s),
                      (this.t1 =
                        "undefined" != typeof Element && b(t, "Element")
                          ? A(t, this.options)
                          : "string" == typeof t
                          ? Y(t, this.options)
                      ...
                      if (t.nodeName !== e.nodeName) {
                        ...
                        return [
                          new g()
                            ...
                            .setValue(this.options._const.oldValue, O(t))
                            .setValue(this.options._const.newValue, O(e))
                            ...
                            ? "#text" === u.nodeName
                              ...
                              : (r.push(
                                  new g()
                                    ...
                                    .setValue(this.options._const.element, O(u))
                                ),
                                (l -= 1))
                            : p &&
                              !u &&
                            ...
                            "#text" === (l = f[v]).nodeName
                              ...
                              : (b.push(
                                  new g()
                                    ...
                                    .setValue(this.options._const.element, O(l))
                                ),
                                h.splice(w, 0, !0),
                                p.splice(w, 0, O(l)),
                                (m = Math.min(h.length, u.length)));
                ...
                F = (function () {
                  ...
                  return (
                            ...
                            !(function (t, e, s) {
                              switch (e[s._const.action]) {
                                case s._const.addAttribute:
                                  ...
                                  break;
                                case s._const.modifyAttribute:
                                  y(e, s._const.oldValue, s._const.newValue),
                                    _(t, e, s);
                                  break;
                                case s._const.removeAttribute:
                                ...
                                case s._const.replaceElement:
                                  ...
                                  break;
                                case s._const.relocateGroup:
                                  y(e, s._const.from, s._const.to), _(t, e, s);
                                  break;
                                case s._const.removeElement:
                    ...
                    (t.prototype.diff = function (t, e) {
                      return new j(t, e, this.options).init();
                    }),
                    t
                  );
                })();
                  ...
                  if (t.data) {
                    ...
                    o.data = t.data.map((t) => {
                      ...
                      return (
                        ...
                        { attributes: i, cells: n.map((t, e) => X(t, s[e])) }
                      );
                    });
                  } else
                    e?.tBodies?.length &&
              ...
              class tt {
                ...
                sort(t, e = void 0, s = !1) {
                  ...
                  this.dt.data.data.sort((s, i) => {
                    ...
                    return n && "number" != typeof l && "number" != typeof d
              ...
              (s.DataTable = class {
                ...
                constructor(t, e = {}) {
                  ...
                  const i = { ...et.diffDomOptions, ...e.diffDomOptions },
                ...
                _renderPagers() {
                  ...
                  let t = ((t, e, s, i, n) => {
                    let a = [];
                    if (
                      (n.firstLast && a.push(st(1, n.firstText, n)), n.nextPrev)
                    ) {
                      const e = t ? 1 : s - 1;
                      a.push(st(e, n.prevText, n, { hidden: t }));
                    }
                    let o = [...Array(i).keys()].map((t) =>
                      st(t + 1, String(t + 1), n, { active: t === s - 1 })
                    );
                    if (
                      (n.truncatePager &&
                        (o = ((t, e, s, i) => {
                      ...
                      const t = e ? i : s + 1;
                      a.push(st(t, n.nextText, n, { hidden: e }));
                    }
                    return (
                  ...
                  if (this.options.destroyable) {
                    if (this.wrapperDOM) {
                      ...
                      if (t) {
                        ...
                        t.replaceChild(s, this.wrapperDOM), (this.dom = s);
                      } else
                        this.options.classes.table
                          ?.split(" ")
                  ...
                  this.data.data.forEach((t, e) => {
                    const n = t.cells.map((t, e) => {
                      ...
                      if (i.length) {
                        ...
                        ["base", "accent"].includes(t) && (i = i.toLowerCase()),
                      ...
                      const n =
                        s.searchItemSeparator ||
                        this.options.searchItemSeparator;
                      return n ? i.split(n) : [i];
                    });
                    i.every((e, i) =>
                      e.find((e, a) => {
                        if (!e) return !1;
                        const o =
                          this.columns.settings[a].searchMethod ||
                          this.options.searchMethod;
                        return o
                          ? o(e, n[a], t, a, s[i].source)
                          : e.find((t) => n[a].find((e) => e.includes(t)));
                      })
                  ...
                  if (Array.isArray(t)) {
                    ...
                    t.forEach((t, i) => {
                      ...
                      Object.entries(t).forEach(([t, s]) => {
                        const a = e.indexOf(t);
                        a > -1
                          ? (n[a] = X(s, this.columns.settings[a]))
                          : this.hasHeadings ||
                            this.hasRows ||
                            0 !== i ||
                            ((n[e.length] = X(
